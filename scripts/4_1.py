...
class LAM_Linear(nn.Module):
    def __init__(self, d_o, d_z, d_a, d_b, learn_A=True, CD_zero=False, pseudo_action=True):
...
def main(learn_A=True, CD_zero=False, pseudo_action=True):
    ...
    for da, dz in product(da_list, dz_list):
        ...
        for i_batch in range(5001):
            ...
            if i_batch % 1000 == 0:
                ...
                total_record.to_csv(f'4_1_learnA{learn_A}_CDzero{CD_zero}_psdaction{pseudo_action}.csv')
